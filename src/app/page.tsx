              ...
              <div className="bg-white rounded-xl border border-gray-100 overflow-hidden shadow-sm hover:shadow-md transition-all hover:translate-y-[-4px]">
                <div className="p-8">
                  ...
                  <div className="flex gap-4">
                    <a 
                      href="https://chatresu.vercel.app/" 
                      target="_blank" 
                      rel="noopener noreferrer"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mr-2"></div>
                    <span className="text-gray-700">CrewAI</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mr-2"></div>
                    <span className="text-gray-700">AutoGPT</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mr-2"></div>
                    <span className="text-gray-700">Context Engineering</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mr-2"></div>
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center">
                    <div className="w-2 h-2 bg-blue-500 rounded-full mr-2"></div>
                    <span className="text-gray-700">Dify</span>
                  </div>
                </div>
              </div>
            </div>
